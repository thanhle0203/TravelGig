    ...
    $(document).ready(function() {
        ...
        $("#planForm").on("submit", function(e) {
            ...
            var collisionDeductible = $("#collisionDeductible").val();
            //var uninsuredMotoristDeductible = parseInt($("#uninsuredMotoristDeductible").val());
            var uninsuredMotoristDeductible = $("#uninsuredMotoristDeductible").val();
	...
	*/
    ...
    var planDetails = {
        ...
        basePrice: data.autoPlan.basePrice,
        collisionDeductible: data.collisionDeductible,
        uninsuredMotoristDeductible: data.uninsuredMotoristDeductible,
