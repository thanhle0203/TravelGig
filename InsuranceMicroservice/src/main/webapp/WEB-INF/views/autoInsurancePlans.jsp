            ...
            <div class="row">
                <div class="col-md-4" style="background-color: #f2f2f2; padding: 20px; border-radius: 10px;">
                    <div class="form-group">
                        ...
                        <label for="collisionDeductibleA">Select Collision Deductible:</label>
                        <select id="collisionDeductibleA" name="collisionDeductibleA">
                            <option value="500">$500</option>
                            <option value="1000">$1000</option>
                        </select>
                        <label for="uninsuredMotoristDeductibleA">Select Uninsured Motorist Protection Deductible:</label>
                ...
                <div class="col-md-4" style="background-color: #d9d9d9; padding: 20px; border-radius: 10px;">
                    <div class="form-group">
                        ...
                        <label for="collisionDeductibleB">Select Collision Deductible:</label>
