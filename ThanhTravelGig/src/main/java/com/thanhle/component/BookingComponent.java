...
public class BookingComponent {
	...
	public JsonNode saveCancelBooking(String bookingId) {
	    HttpHeaders headers = new HttpHeaders();
	    headers.setContentType(MediaType.APPLICATION_JSON);
	    ...
	    ResponseEntity<Object> responseEntity = restTemplate.exchange(
	            "http://localhost:8484/bookings/cancelledBooking/" + bookingId,
	            HttpMethod.POST,
	            request,
	            Object.class
	    );
	...
	public JsonNode findCancelBookingsByPhone(String mobile) {
		RestTemplate restTemplate = new RestTemplate();
		ResponseEntity<Object> responseEntity = restTemplate
				.getForEntity("http://localhost:8484/bookings/getCancelledBooking/" + mobile, Object.class);
		Object objects = responseEntity.getBody();
	...
	public JsonNode findBookingsByUser(String mobile) {
		RestTemplate restTemplate = new RestTemplate();
		ResponseEntity<Object> responseEntity = restTemplate
				.getForEntity("http://localhost:8484/bookings/mobile/" + mobile, Object.class);
		Object objects = responseEntity.getBody();
	...
	public JsonNode findReviewsByHotelId(String hotelId) {
		RestTemplate restTemplate = new RestTemplate();
		ResponseEntity<Object> responseEntity = restTemplate
				.getForEntity("http://localhost:8383/reviews/" + hotelId, Object.class);
		Object objects = responseEntity.getBody();
